...
public class Account {
    ...
    public double getInterest(){
         ...
         double temp = 0;
         if(this.type==1) temp=0;
         else if(this.type==2){
            temp=(this.balance)*srate;
            this.balance+=(this.balance)*srate;
         }
         else if(this.type==3){
             temp=(this.balance)*drate;
            this.balance+=(this.balance)*drate;
         }
         return temp;
    }
